  ...
  <v-container fluid grid-list-xl>
    <v-layout row wrap>
      <v-flex md12 text-md-center mt-5>
        <img src="@/assets/ucsmub.png" alt="UCS Maubin" width="80">
      </v-flex>
    ...
    <br>
    <!-- result -->
    <v-layout row wrap v-if="isSearch">{{ result }}</v-layout>
    <!-- cate -->
    <v-layout row wrap v-if="!isSearch" mt-5 mb-5>
      <v-layout>
        <v-flex xs12 sm4 offset-md0>
          <v-card>
            <v-card-title primary-title>
              <div>
                <h3 class="headline mb-0">FIRST YEAR</h3>
              </div>
            </v-card-title>
        ...
        <v-flex xs12 sm4 offset-sm1>
          <v-card>
            <v-card-title primary-title>
              <div>
                <h3 class="headline mb-0">SECOND YEAR(CS)</h3>
              </div>
            </v-card-title>
        ...
        <v-flex xs12 sm4 offset-sm1>
          <v-card>
            <v-card-title primary-title>
              <div>
                <h3 class="headline mb-0">SECOND YEAR(CT)</h3>
              </div>
            </v-card-title>
      ...
      <v-layout>
        <v-flex xs12 sm4 offset-md0>
          <v-card>
            <v-card-title primary-title>
              <div>
                <h3 class="headline mb-0">THIRD YEAR(CS)</h3>
              </div>
            </v-card-title>
        ...
        <v-flex xs12 sm4 offset-sm1>
          <v-card>
            <v-card-title primary-title>
              <div>
                <h3 class="headline mb-0">THIRD YEAR(CT)</h3>
              </div>
            </v-card-title>
        ...
        <v-flex xs12 sm4 offset-sm1>
          <v-card>
            <v-card-title primary-title>
              <div>
                <h3 class="headline mb-0">FOURTH YEAR(CS)</h3>
              </div>
            </v-card-title>
      ...
      <v-layout>
        <v-flex xs12 sm4 offset-md0>
          <v-card>
            <v-card-title primary-title>
              <div>
                <h3 class="headline mb-0">FOURTH YEAR(CT)</h3>
              </div>
            </v-card-title>
        ...
        <v-flex xs12 sm4 offset-sm1>
          <v-card>
            <v-card-title primary-title>
              <div>
                <h3 class="headline mb-0">FIFTH YEAR(CS)</h3>
              </div>
            </v-card-title>
        ...
        <v-flex xs12 sm4 offset-sm1>
          <v-card>
            <v-card-title primary-title>
              <div>
                <h3 class="headline mb-0">FIFTH YEAR(CT)</h3>
              </div>
            </v-card-title>
